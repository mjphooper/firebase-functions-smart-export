 ...
 */
export function flattenFunctionRegistry(registry: FunctionRegistry): Record<FunctionId, FunctionReference> {
  const flatRecord: Record<FunctionId, FunctionReference> = {};

  function recursiveTraverseAndFlatten(registry: FunctionRegistry, currentPath: string[] = []) {
