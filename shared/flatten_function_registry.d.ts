...
import { type FunctionReference, type FunctionRegistry } from "./types/function_registry.js";
/**
 ...
 */
export declare function flattenFunctionRegistry(registry: FunctionRegistry): Record<FunctionId, FunctionReference>;
